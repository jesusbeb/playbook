...
const exercisesFinishedTrue = explorers.some((item) => item.exercisesFinished === true);
console.log("Por lo menos alguno de los explorers ha finalizado todos los ejercicios de frontend: " +exercisesFinishedTrue);